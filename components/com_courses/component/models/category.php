...
jimport('joomla.application.component.model');
  ...
  class CoursesModelCategory extends JModel
  {
  /**
* Category id
*
...
var $_id = null;
 ...
 // Get the pagination request variables
  $this->setState('limit', $mainframe->getUserStateFromRequest('com_courses.limit', 'limit', $config->getValue('config.list_limit'), 'int'));
