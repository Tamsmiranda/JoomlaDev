...
jimport('joomla.application.component.view');
  ...
  * @package Courses
  */
  class CoursesViewItem extends JView
  {
  		function display($tpl = null)
 	    {
			...
			$query = "SELECT * "
			. " FROM #__videos"
			. " WHERE course_id = " . (int)$item->id . ' AND published=1 ORDER BY ordering ASC';
			$db->setQuery($query);
			$videos = $db->loadAssocList();
			$document->setTitle( $params->get( 'page_title' ) );
 			...
 			$this->assignRef('courseUserVideos',$model->getCourseUserOrder());
