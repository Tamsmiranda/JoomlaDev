...
/**
  ...
  * @package Courses
  */
  class CoursesViewCategory extends JView
  {
...
//get the categories model, so we can use it also here
 $model =& JModel::getInstance('categories', 'coursesmodel');
 ...
 // Use the static HTML library to build the image tag
  $category->image = JHTML::_('image', 'images/stories/'.$category->image, JText::_('COURSES'), $attribs);
  }
 ...
 $count = count($categories);
  ...
  {
  $cat =& $categories[$i];
  $cat->link = JRoute::_('index.php?option=com_courses&view=category&id='. $cat->slug);
  }
