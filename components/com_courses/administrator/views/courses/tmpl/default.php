...
<?php
  ...
  JToolBarHelper::title( JText::_( 'Cursos' ), 'generic.png' );
	...
	<table class="adminlist">
		<thead>
			<tr>
				...
				<th class="title">
					<?php echo JHTML::_('grid.sort', 'Criado', 'a.created', $this->lists['order_Dir'], $this->lists['order'] ); ?>
				</th>
				<th class="title">
					<?php echo JHTML::_('grid.sort', 'Criado por', 'a.created_by', $this->lists['order_Dir'], $this->lists['order'] ); ?>
				</th>
				<th class="title">
					<?php echo JHTML::_('grid.sort', 'Modificado', 'a.modified', $this->lists['order_Dir'], $this->lists['order'] ); ?>
				</th>
				<th class="title">
					<?php echo JHTML::_('grid.sort', 'Modificado por', 'a.modified_by', $this->lists['order_Dir'], $this->lists['order'] ); ?>
				</th>
				<th width="5%" nowrap="nowrap">
					<?php echo JHTML::_('grid.sort', 'Publicado', 'a.published', $this->lists['order_Dir'], $this->lists['order'] ); ?>
				</th>
				<th width="8%" nowrap="nowrap">
					<?php echo JHTML::_('grid.sort', 'Ordem', 'a.ordering', $this->lists['order_Dir'], $this->lists['order'] ); ?>
					<?php echo JHTML::_('grid.order', $this->items ); ?>
				</th>
				<th width="15%" class="title">
					<?php echo JHTML::_('grid.sort', 'Categoria', 'category', $this->lists['order_Dir'], $this->lists['order'] ); ?>
				</th>
...
<?php
  ...
  {
  $row = &$this->items[$i];
 $link = JRoute::_( 'index.php?option=com_courses&view=item&task=edit&cid[]='. $row->id );
 ...
 $row->cat_link = JRoute::_( 'index.php?option=com_categories&section=com_courses&task=edit&type=other&cid[]='. $row->catid );
  ?>
