...
<?php
  ...
  {
  $row = &$this->items[$i];
 $link = JRoute::_( 'index.php?option=com_courses&controller=videos&view=video&task=edit&cid[]='. $row->id );
 ...
 $row->cat_link = JRoute::_( 'index.php?option=com_categories&section=com_courses&controller=videos&task=edit&type=other&cid[]='. $row->catid );
  ?>
