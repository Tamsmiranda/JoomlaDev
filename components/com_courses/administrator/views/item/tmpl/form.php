...
<td width="100" align="right" class="key">
<label for="price">
<?php echo JText::_( 'Preço' ); ?>:
</label>
</td>
<td>
<input class="text_area" type="text" name="price" id="price" size="32" maxlength="250" value="<?php echo $this->item->price;?>" />
</td>
</tr>
...
<?php 
	...
	echo $editor->display( 'description', $this->item->description, '400', '400', '20', '20', false, $params );
?>
