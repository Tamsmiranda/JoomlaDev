...
<label for="materia">
<?php echo JText::_( 'Materia' ); ?>:
</label>
</td>
<td>
<input class="text_area" type="text" name="materia" id="materia" size="48" maxlength="250" value="<?php echo $this->item->materia;?>" />
</td>
</tr>
<tr>
<td width="100" align="right" class="key">
...
<td width="100" align="right" class="key">
<label for="max_hit">
<?php echo JText::_( 'Máximo de visualizações' ); ?>:
</label>
</td>
<td>
<input class="text_area" type="text" name="max_hit" id="max_hit" size="32" maxlength="250" value="<?php echo $this->item->max_hit;?>" /> 
</td>
</tr>
...
<td>
<?php echo $this->courseslists['course_id']; ?>
</td>
</tr>
 <tr>
<td width="100" align="right" class="key">
<label for="url">
<?php echo JText::_( 'Embed' ); ?>:
</label>
</td>
<td>
